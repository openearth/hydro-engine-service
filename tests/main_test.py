...
class TestClient:
    ...
    def test_get_bathymetry_vaklodingen(self):
        ...
        r = self.client.get(
            "/get_bathymetry", data=json.dumps(input), content_type="application/json"
        )
    ...
    def test_get_raster_profile(self):
        line = {
            ...
            "polyline": {
                ...
                "type": "LineString",
                "coordinates": [
                    [5.03448486328125, 53.53541058046374],
                    [5.58380126953125, 53.13029407190636],
                ],
            },
            "scale": 100,
        }
    ...
    def test_get_catchments(self):
        ...
        r = self.client.post(
            "/get_catchments", data=json.dumps(request), content_type="application/json"
        )
        assert r.status_code == 200
    ...
    def test_get_rivers(self):
        ...
        r = self.client.post(
            "/get_rivers", data=json.dumps(request), content_type="application/json"
        )
        assert r.status_code == 200
    ...
    def test_get_lakes(self):
        ...
        r = self.client.post(
            "/get_lakes", data=json.dumps(request), content_type="application/json"
        )
    ...
    def test_get_water_mask(self):
        ...
        r = self.client.post(
            "/get_water_mask", data=json.dumps(request), content_type="application/json"
        )
    ...
    def test_get_sea_surface_height_time_series(self):
        ...
        request = {"region": {"type": "Point", "coordinates": [54.0, 0.0]}}
    ...
    def test_get_liwo_scenarios_max_regional_and_primary(self):
        """test get liwo scenarios max"""
        request = {"liwo_ids": [209, 10634], "band": "waterdepth", "reducer": "max"}
        resp = self.client.post(
            "/get_liwo_scenarios",
            data=json.dumps(request),
            content_type="application/json",
    ...
    def test_v2_get_liwo_scenarios_max_no_region(self):
        """test get liwo scenarios max"""
        request = {"liwo_ids": [18037, 18038, 18039], "band": "waterdepth"}
        resp = self.client.post(
    ...
    def test_v2_get_liwo_scenarios_max_regional_and_primary(self):
        """test get liwo scenarios max"""
        request = {"liwo_ids": [18037, 621], "band": "waterdepth"}
        resp = self.client.post(
            "/v2/get_liwo_scenarios",
            data=json.dumps(request),
            content_type="application/json",
    ...
    def test_get_glossis_data_with_waterlevel(self):
        ...
        request = {"dataset": "waterlevel", "band": "water_level"}
        resp = self.client.post(
            "/get_glossis_data",
            data=json.dumps(request),
            content_type="application/json",
    ...
    def test_get_gloffis_data(self):
        ...
        request = {"dataset": "weather", "band": "mean_temperature"}
        resp = self.client.post(
            "/get_gloffis_data",
            data=json.dumps(request),
            content_type="application/json",
    ...
    def test_get_gloffis_data_log(self):
        ...
        request = {"dataset": "hydro", "band": "discharge_routed_simulated"}
        resp = self.client.post(
            "/get_gloffis_data",
            data=json.dumps(request),
            content_type="application/json",
    ...
    def test_get_metocean_data(self):
        ...
        request = {"dataset": "percentiles", "band": "50th"}
        resp = self.client.post(
            "/get_metocean_data",
            data=json.dumps(request),
            content_type="application/json",
    ...
    def test_get_gebco_data(self):
        ...
        request = {"dataset": "gebco"}
        resp = self.client.post(
            "/get_gebco_data", data=json.dumps(request), content_type="application/json"
        )
        assert resp.status_code == 200
    ...
    def test_get_feature_info_null(self):
        request = {
            ...
            "function": "log",
            "bbox": {"type": "Point", "coordinates": [-28.23, 49.05]},
        }
        resp = self.client.post(
            "/get_feature_info",
            data=json.dumps(request),
