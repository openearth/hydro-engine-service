...
def get_windfarm_data():
    ...
    def create_turbine_grid(feature, spacing):
        ...
        x_grid = ee.List.sequence(left, right, spacing)
        y_grid = ee.List.sequence(lower, upper, spacing)
        ...
        props = props.set('spacing', spacing)
